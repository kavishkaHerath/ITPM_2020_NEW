...
<html>
    <head>
        ...
        <%
             String productSelected = request.getParameter("filena");
  ...
  <div class="top_navbar">
    ...
    for (int i=0;i<size;i++) {
      ...
      String sqwe = (String)filenames.get(i);
      if(sqwe.endsWith(".java")){
     // namee = sqwe;
      
    %>
    <option value="<%=sqwe%>"  ><%=sqwe%></option>
    <%
    }}
    %>
    </select>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                ArrayList<SizeDTO> List= svm.measureSize(productSelected);
